...
public class Root implements java.io.Serializable
{
   ...
   private java.util.List<cnk.air_commercialscalculationengine.settlementrules.BusinessRuleIntake> businessRuleIntake;
   ...
   public java.util.List<cnk.air_commercialscalculationengine.settlementrules.BusinessRuleIntake> getBusinessRuleIntake()
   {
      return this.businessRuleIntake;
   }

   public void setBusinessRuleIntake(
         java.util.List<cnk.air_commercialscalculationengine.settlementrules.BusinessRuleIntake> businessRuleIntake)
   {
